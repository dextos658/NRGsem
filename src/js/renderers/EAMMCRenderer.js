...
export class EAMMCRenderer extends AbstractRenderer {
...
constructor(gl, volume, environmentTexture, options) {
    ...
    this._programs = WebGL.buildPrograms(gl, SHADERS.renderers.EAMMC, MIXINS);
}
...
_integrateFrame() {
    ...
    gl.uniform1f(uniforms.uAbsorptionCoefficient, this.extinction);
